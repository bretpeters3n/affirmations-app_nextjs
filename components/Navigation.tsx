...
const Navigation = () => {
  ...
  return (
    <div className="">
      <nav className="tm-gradient text-slate-700 font-manrope text-xl z-10 pointer-events-none flex flex-row h-[85px]">
        <div className="">
          <button
            type="button"
            id="hamburger"
          ...
          >
            <svg
              width="40"
              height="40"
              className="fixed top-4 left-4 drop-shadow-[0_0_10px_rgba(0,0,0,.5)]"
              viewBox="0 0 100 100"
            >
              {/* NEW */}
              <path
        ...
        <div id="appName" className="w-full text-center absolute top-6">
          Affirmations
        </div>

        <div className="z-20 pointer-events-auto absolute top-6 right-6">
          <UserButton />
        </div>
      </nav>
    </div>
